...
class C_rekap_skp extends CI_Controller {
    ...
    public function index() {
        $data['lokasi']=$this->db->get('tbllokasikerja')->result_array();
    ...
    public function lihat_laporan() {
        ...
        if($lokasi!=="all"){
            $filterLokasi=" AND f.KodeLokasi=$lokasi";
        }else{
            $filterLokasi=" ";
        }
        $par_status = "";
...
//                }
        ...
        $q = "select a.nip,a.nama,c.jabatan,d.unitkerja,f.Lokasi,b.nilai_skp,b.id_opmt_bulanan_skp
               ...
               LEFT JOIN tbljabatan c on c.kodejab=a.jabatan
               LEFT JOIN tblstruktural d on d.kodeunit=a.unit_kerja
               LEFT JOIN tblrekaptk e on e.nip=a.nip
               LEFT JOIN tbllokasikerja f on f.KodeLokasi=e.kodelokasi
               where 1=1 {$par_unit} {$par_status} {$filterLokasi}";
