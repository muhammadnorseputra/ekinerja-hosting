...
if($hasil==0){
    ...
    public function validasi() {
        ...
        //if($user == '199412242019032007' OR $user == '198104072009041002' OR $user == 'admin2') {
        	
        
        if ($konek AND ($user != "admin2")) { // admin2 alexsya2255
          //$this->session->set_flashdata('pesan', "Terhubung dengan SILKa Online");
          // cek nip pada silka
          $url = 'http://localhost/silka/index.php/api/cek_pns_ekinerja?nip='.$user;
          //$url = 'http://ekinerja.bkppd-balangankab.info/c_api/get_skp_blnnip_silka?nip='.$nip.'&thn='.$thn.'&bln='.$bln;
        ...
        // JIka tidak terhubung dengan SILKa Online, tidak dilakukan update data profil dd_user
        } else {
            //$this->session->set_flashdata('pesan', "SILKa Online Not Connected");
            //redirect('./');
        ...
        //} else {
        	//redirect(base_url('./'));
        	//echo "<pre>The application is still in the stabilization stage by Tim InfoPeg.<pre>";
        //}
