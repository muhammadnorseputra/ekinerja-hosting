...
<table class="table" id="tbl_realisasi">
    ...
    <tbody>
        ...
        foreach ($real as $real_arr) {
            ...
            $persentase_waktu = 100 - ($real_waktu / $target_waktu_nilai * 100);
            if ($persentase_waktu <= 24) {
                $nilai_waktu = ((1.76 * $target_waktu_nilai - $real_waktu) / $target_waktu_nilai) * 100;
            } else {
                $nilai_waktu = 76 - ((((1.76 * $target_waktu_nilai - $real_waktu) / $target_waktu_nilai) * 100) - 100);
            }
