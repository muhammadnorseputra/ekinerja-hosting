<style>
    ...
    #tbl_realisasi thead{
        background-color:#006e2e;text-align:center;font-weight:normal;color:white;border:solid 1px black;
    ...
    <table class="table" id="tbl_realisasi">
        <thead class="ui-state-default">
            <tr>
                ...
                <td class="tengah" rowspan="2">Tgl. Entri</td>
                    ...
                    <td class="tengah" width='120'>                    
                        <?php
                            ...
                            if ($real_arr['tgl_entri'] == NULL) {
                                ...
                                $tglentri = date('D, d M Y h:i:s',strToTime($real_arr['tgl_entri']));
                            } 
...
//                        if ($perhitungan !== "") {
                        ...
                        if ($real_arr['ket'] == 'turunan'&&($real_arr['id_dd_user_bawahan']==''||$real_arr['id_dd_user_bawahan']==0)) {
                            $no_2++;
                        } else if($real_arr['ket']=='turunan'&&$par=='turunan') { 
                            $no_2++;
                        }
...
$i++;
            ...
            <tr style="background-color:#dff0d8;text-align: center;font-weight: bold;">
                <td colspan="12" align='left'>Nilai SKP :
                    <code>
            ...
            ?>
            <tr style="background-color:#dff0d8;text-align: center;font-weight: bold;">
                <td colspan="12" align='left'>Total Nilai SKP : 
                <code>
    ...
    ?>
        ...
        <span class='text-info'><<< Approval secara otomatis akan meng-export Nilai SKP ke SILKa Online</span>
    <?php
    }
    ?>
</div>
