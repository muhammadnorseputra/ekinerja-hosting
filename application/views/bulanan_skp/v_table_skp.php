...
<div style="padding:10px;margin-top:-30px;">
    ...
    <div style="float:left;">
        <button onclick="tambah_periode_bulanini()" class="btn btn-warning"><i class="fa fa-plus-circle"></i> Tambah Periode Bulan Ini</button>
    </div>
