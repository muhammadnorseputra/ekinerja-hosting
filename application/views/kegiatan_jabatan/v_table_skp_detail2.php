...
<?php 
$jabatan=!empty($jabatan['jabatan'])?$jabatan['jabatan']:'';
?>
<h4 style="text-align: center;"><?= 'JABATAN ' . strtoupper($jabatan) ?></h4>
    ...
    <div style="float:right;">
        <span>
            <table>
                <tr>
                <td>
<select class="form-control" id="jabatanPar">
<?php foreach($arrJabatan as $dt){?>
