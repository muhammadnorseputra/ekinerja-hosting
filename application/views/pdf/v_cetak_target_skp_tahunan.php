    ...
    <tbody>
        ...
        foreach ($target as $arr) {
            ...
            <tr>
                ...
                <td align="center"><?= $arr['angka_kredit_total'] ?></td>
...
<table style="width:100%;" style="text-align: center;color:black;font-size: 12px;font-weight:bold;">
    <tr>
        <td width="300"><?= hanya_tgl_indo($tanggal) ?></td>
        <td width="300"></td>
        <td align="center" width="600"><?= $lokasi['lokasi_spesimen'] ?>, <?= date('d F Y', strtotime($tanggal)) ?></td>
    </tr>
    <tr>
