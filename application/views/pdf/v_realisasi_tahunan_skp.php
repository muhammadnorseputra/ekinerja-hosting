...
<div class="row">
    <div class="col-lg-12" style="text-align:center;font-weight:bold;font-size:14px;">
        <span>PENILAIAN SASARAN KERJA PEGAWAI</span>
    </div>
</div>
<div class="row">
    <div class="col-lg-12" style="text-align:center;font-weight:bold;font-size:14px;">
...
<br>
Jangka Waktu Penilaian <?= hanya_tgl_indo(date('d-m-Y', strtotime($periode['awal_periode_skp']))) . ' s.d ' . hanya_tgl_indo(date('d-m-Y', strtotime($periode['akhir_periode_skp']))) ?>
...
<table width="100%" id="tbl_realisasi" style="color:black;">
    <thead>
        ...
        <tr style="background:#C0C0C0;font-weight:bold;"><td width="70">Kuantitas</td><td width="70">Kualitas</td><td width="70">Waktu</td><td width="70">Biaya</td><td width="70">Kuantitas</td><td width="60">Kualitas</td><td width="60">Waktu</td><td width="60">Biaya</td><td width="80">Perhitungan</td><td width="60">Nilai</td></tr>
    </thead>
    <tbody>
        <?php
        $no = 1;
        foreach ($real as $real_arr) {
            ...
            <tr>
                ...
                <td width="430" style="text-align: left;"><?= $real_arr['kegiatan_tahunan'] ?></td>
                <td width="100"><?= $target_kuantitas ?></td>
                <td align="center">100</td>
                <td align="center"><?= $target_waktu . ' bulan' ?></td>
                <td align="center"><?= number_format($target_biaya) ?></td>
                <td width="100" align="left"><?= $real_arr['realisasi_kuantitas'] . ' ' . $real_arr['satuan_kuantitas'] ?></td>
                <td align="center"><?= number_format($real_arr['realisasi_kualitas']) ?></td>
        ...
        ?>
        <tr style="background:#dff0d8;font-weight:bold;">
            <td colspan="11" align="center">NILAI CAPAIAN SKP</td>
...
<table style="width:100%;" style="text-align: center;color:black;font-size: 12px;font-weight:bold;">
    ...
    <tr><td></td><td width="300"></td><td><?= strtoupper($atasan['nama']) ?></td></tr>

    <tr><td></td><td width="300"></td><td>NIP. <?= $atasan['nip'] ?></td></tr>
</table>