        ...
        <div style="float:left;">
            <table>
                <tr>
                    ...
                    <td>                 
                        <div class="input-group">
                            <div class="input-group-addon">Lokasi</div>
                            <select class="form-control ui-state-focus" id="lokasi">
                            <option value="all">ALL</option>
                                <?= pilihan_list($lokasi, 'Lokasi', 'KodeLokasi','') ?>
                            </select>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="input-group">
                            ...
                            <select class="form-control ui-state-default" id="status">
                                ...
                                <option value="2" selected="">Belum Disetujui</option>                                
                                <option value="3">Belum Membuat SKP Bulanan</option>                                
                            </select>
                        </div>
                    </td>
                    <td>   
...
<script>
    function lihat_laporan() {
     ...
     //   });
			 $.ajax({
                                                url: 'admin/c_rekap_skp/lihat_laporan',
                                                type: 'post',
						data:{bulan: bulan, tahun: tahun, jenis: jenis, status: status,lokasi:lokasi},
                                                dataType: "html",
                                                beforeSend: function () {
                                                    NProgress.start();
                                                   $('#ajaxLaporan').hide('slow');                                                   
                                                },
                                                success: function (data) {
                                                    NProgress.done();
   						    $('#ajaxLaporan').show('slow');    
                                                    $('#ajaxLaporan').html(data);                                                }
                                            });
