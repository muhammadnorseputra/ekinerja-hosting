...
<script type="text/javascript">
    ...
    function cetak() {
        ...
        BootstrapDialog.show({
            ...
            //message: '<table class="table"><tr><td><select class="form-control" id="lokasi"><?= pilihan_list($spesimen, "lokasi_spesimen", "id_dd_spesimen", "") ?></select></td><td><input class="form-control" placeholder="Tanggal Cetak" size="15" maxlength="10" type="text" name="tanggal" id="tanggal"><button class="btn ui-state-default" onclick="cetak_target_tahunan_skp()">Cetak</button></td></tr></table>'
        });
        //dialog.realize();
        //dialog.getModalBody().css('background-color', 'lightblue');
        //dialog.getModalBody().css('color', '#000');
        //dialog.setSize(BootstrapDialog.TYPE_DANGER);
        //dialog.open();
    }
