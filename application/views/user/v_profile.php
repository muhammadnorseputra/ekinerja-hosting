    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="atasan_2" id="atasan_2_id" value="<?= $user['atasan_2'] ?>" disabled>
        </tr>
        <tr>
            <td>Atasan III</td>
            <td> : </td>
            <td>
                ...
                <input type="hidden" name="atasan_3" id="atasan_3_id" value="<?= $user['atasan_3'] ?>" disabled>
        </tr>
...
<?php foreach($uker as $dt){?>	
<option value="<?=$dt->kodeunit?>" <?=$dt->kodeunit==$uker_data?'selected':''?>><?=$dt->unitkerja?></option>
<?php }?>
</select>
            </td>
        </tr>
...
<option value="<?=$dt->kodejab?>" <?=$dt->kodejab==$jabatan_data?'selected':''?>><?=strtoupper($dt->jabatan)?></option>
<?php }?>
</select>            
</td>
        </tr>
        <tr>
            <td>Pangkat1/Gol. Ruang</td>
            <td> : </td> 
            <td>
                <input type="text" class="form-control gol_ruang" value="<?= $pangkat ?>"> 
                <input type="hidden" name="gol_ruang" id="gol_ruang" value="<?= $kodegol ?>">
            </td>
        </tr>
        <tr>
            <td></td>
