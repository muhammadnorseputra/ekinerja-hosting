    ...
    <table class="table" id="tbl_realisasi">
        <thead class="ui-state-default">
            <tr>
                ...
                <td class="tengah" rowspan="2" style="vertical-align: middle;">Tgl. Entri</td>
...
<i class="fa fa-pencil text-success"/>
                ...
                <tr class="<?= $real_arr['ket'] == 'utama' ? 'judul' : ''; ?><?=(($real_arr['realisasi_kuantitas']>$real_arr['target_kuantitas'])&&($real_arr['target_kuantitas']>0))?' danger':''?>">
                    ...
                    <td class="tengah danger"><?= $real_arr['turunan'] == 1 ? "" : $real_arr['realisasi_kualitas'] ?></td>
                    ...
                    <td class = "angka"><?= $real_arr['turunan'] == 1 ? "" : number_format($real_arr['realisasi_biaya'])
                        ?></td> 
                    <!--<sup style="color:white;"><sup><?//= $real_arr['turunan'] == 1 ? "" : number_format($nilai,2); ?></sup></sup>-->
                    <!--<span style="color:black; font-size:8px"><?= $real_arr['turunan'] == 1 ? "" : number_format($ttl_nilai[] = $nilai,2); ?></span>-->
                </tr> 
            ...
            ?>
            <br/>
            <span style="color:white; font-size:10px; float:right;"><?= $i == 0 ? $total_nilai = 0 : number_format($total_nilai = array_sum($ttl_nilai) / $k, 2) ?></span>
            <?php
