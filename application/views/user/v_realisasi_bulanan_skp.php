    ...
    <table class="table" id="tbl_realisasi">
        <thead class=" ui-state-default ">
            <tr>
                ...
                <td class="tengah" rowspan="2" style="vertical-align: middle;">Entri/Update Terakhir</td>
                <td class="tengah" rowspan="2" style="vertical-align: middle;">Kegiatan Bulanan</td>
                <td colspan="4">Target</td>
                <td colspan="4">Realisasi</td>
                <td class="tengah" rowspan="2" style="vertical-align: middle;">Status Penilaian</td>
            </tr>
            <tr>
                <td>Kuantitas</td>
                <td>Kualitas</td>
                    ...
                    <?php
                        if ($real_arr['turunan'] == 0) {
                            if ($real_arr['realisasi_kualitas'] >= 1) {
                                ...
                                echo "<span class='text-success'><b>Belum Dinilai</b><span>";
                            }
                        }
                    ?>
                    </td>
...
<?php if(!isset($cetak)){ ?>
    <button class="btn btn-success pull-right btn-lg" onclick="cetak_realisasi()"><span class="fa fa-print" aria-hidden="true"></span> Cetak Realisasi</button>
        <?php }?>
</div>
<script>
   ...
   function cetak_realisasi() {
        BootstrapDialog.show({
            ...
            message: '<table class="table"><tr><td><select class="form-control" id="lokasi"><option value="1">Balangan</option></select></td><td><button class="btn ui-state-default" onclick="cetak_realisasi_bulanan_skp()">Cetak</button></td></tr></table>'
        });
    }
