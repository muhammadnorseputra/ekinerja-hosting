        ...
        <tbody>
            ...
            foreach ($real as $real_arr) {
                ...
                if ($persentase_biaya <= 24) {
                    ...
                    $nilai_biaya = $target_biaya_nilai == 0 ? 0 : 76 - ((((1.76 * $target_biaya_nilai - $real_biaya) / $target_biaya_nilai) * 100) - 100);
                }
                    ...
                    <td align="left"><?= $real_arr['kegiatan_tahunan'] ?>
                        <?php
                            ...
                            while ($j <= 12) { 
                                ...
                                if ($jmlharianturunan) {
                                    echo bulan_indo($j)." : ".$jmlharianturunan."/ ";
                                }        
                                $j++;
                            }
                            echo "</small>";
...
<input type="hidden" id="id_opmt_tahunan_skp" value="<?=$id?>">
    ...
    <button class="btn btn-primary pull-right btn-lg" onclick="cetak_realisasi()"><i class=" fa fa-print"></i> Cetak</button>
</div>
<script>
    ...
    function cetak_realisasi() {
        BootstrapDialog.show({
            title: 'Cetak Realisasi Tahunan SKP',
