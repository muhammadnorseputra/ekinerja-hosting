    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" class="form-control isi" onkeyup="return hanyaAngka(event)" name="target_kuantitas" value="<?= $target_kuantitas ?>"></td>
...
<script>
    function hanyaAngka(evt) {
        ...
        if (frm_target_bulanan_skp.target_kuantitas.value == "0") {            
                frm_target_bulanan_skp.target_kuantitas.value = "";
