...
<div style="padding:10px;">
    ...
    <table class="table table-condensed table-hover" id="tbl_realisasi">
        <thead class=" ui-state-default ">
            <tr>
                <td class="tengah">No</td>
                <td class="tengah">Entri/Update terakhir</td>
                    ...
                    <td align="center">
                        ...
                        if ($real_arr['id_dd_user'] == $id_user) {
                            if ($real_arr['ket'] == 'utama') {
                                ?>
                                <a href="javascript:void(0)" onclick="ubah_target_bulanan_skp('<?= $real_arr['id_opmt_target_bulanan_skp'] ?>', '<?= $real_arr['id_opmt_bulanan_skp'] ?>')"><i class="fa fa-pencil-square-o fa-2x text-warning"></i></a>
                                <?php
    ...
    <button class="btn btn-warning btn-sm pull-right" onclick="cetak()"><i class="fa fa-print"></i> Cetak</button>
</div>
<script>
